 ...
 ****************************************************/
#define BLYNK_TEMPLATE_ID "TMPL6WbkgnwiA"
#define BLYNK_TEMPLATE_NAME "DHT BY SAJAL 1089"
#define BLYNK_AUTH_TOKEN "Yj_4orjAOqAlAi8QuBCAPQOfDHInpObq" // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
